...
def delay_print(s):
    for c in s:
        ...
        sys.stdout.flush()
        time.sleep(0.1)
delay_print(green+'%37s' % '   |Devoloped By : SMM Master|\n')
print()
print(red+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print(blue+'Telegarm Chanel: https://t.me/TERMUXMASTERTG')
print(blue+'Telegarm Grop : https://t.me/ShareToolBuffViewTikTok')
print(red+'~~~~~~~~~~~~~~+~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print('''
[1] Update Tool
[2] WPS HACK
